...
public class Util {
	...
	public static final Tag<Block> terracotta = new BlockTags.Wrapper(new ResourceLocation(OneBlockMC.MODID,"terracotta"));
	
	public static Block spawn(){
		
		int i = rand.nextInt(1024) + 1;
		...
		switch (i) {
			...
			case 483:
			case 484:
				return Blocks.CHISELED_QUARTZ_BLOCK;
			case 485:
			case 486:
			case 487:
			case 488:
			...
			case 842:
				return  Blocks.TUBE_CORAL_BLOCK;
			case 843:
			case 844:
			...
			case 852:
				return Blocks.DRIED_KELP_BLOCK;
			case 853:
			case 854:
			case 855:
			case 856:
			...
			case 861:
				return Blocks.FIRE_CORAL_BLOCK;
			case 862:
			...
			case 879:
			case 880:
				return  Blocks.GRASS_BLOCK;//[SNOWY = TRUE];
			case 881:
			case 882:
			case 883:
			case 884:
